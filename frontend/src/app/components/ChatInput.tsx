  ...
  return (
    <div className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        {attachedFiles.length > 0 && (
          <div className="mb-3 flex flex-wrap gap-2">
            {attachedFiles.map(file => (
              <div
                key={file.id}
                className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/20 rounded-lg border-2 border-blue-200 dark:border-blue-700/50 shadow-sm"
              >
        ...
        <div className="relative flex items-end gap-2 bg-slate-50 dark:bg-slate-900 rounded-2xl border-2 border-slate-200 dark:border-slate-700 p-2 shadow-lg focus-within:border-blue-500 dark:focus-within:border-blue-500 transition-colors">
          {/* File Input (Hidden) */}
          <input
            ref={fileInputRef}
            type="file"
          ...
          <Button
            ...
            size="icon"
            className="size-10 flex-shrink-0 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl shadow-lg shadow-blue-500/30 disabled:opacity-50 disabled:shadow-none"
          >
